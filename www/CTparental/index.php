...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://127.0.0.10/css/bootstrap.min.css" type="text/css">
        <link rel="stylesheet" href="https://127.0.0.10/css/main.css" type="text/css">
        
        <script src="https://127.0.0.10/js/jquery-1.12.3.min.js"></script>
        <script src="https://127.0.0.10/js/bootstrap.min.js"></script>
    </head>
    ...
    <body>
        <div class="container">
            ...
            <div class="jumbotron">
                <img src="https://127.0.0.10/images/2518388623_1.png" />
